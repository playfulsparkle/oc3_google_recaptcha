...
$_['text_getting_started']             = '<p><strong>نظرة عامة:</strong> تألق مرح - جوجل reCAPTCHA هو إضافة متقدمة لـ OpenCart 4، مصممة لحماية متجرك من البريد العشوائي وإساءة الاستخدام. وهو يدعم تطبيقات متعددة لجوجل reCAPTCHA، بما في ذلك القائم على النتيجة (الإصدار 3)، ومربع الاختيار (الإصدار 2)، وغير المرئي (الإصدار 2)، مما يوفر مرونة وأمانًا محسّنًا لمتجرك.</p><p><strong>المتطلبات:</strong> OpenCart 3.x+، PHP 7.3 أو أعلى</p>';
