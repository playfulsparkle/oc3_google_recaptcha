...
Thank you for your interest in contributing to the Playful Sparkle Google reCAPTCHA extension! We value contributions from the community to enhance this project for all users. Whether you're fixing bugs, adding features, improving documentation, or translating the extension, your efforts are greatly appreciated.
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_google_recaptcha/issues) to avoid duplicates.
...
- Validate edge cases, such as different forms, user roles, or CAPTCHA scenarios.
- Confirm that your changes do not conflict with core OpenCart functionality or Google reCAPTCHA integration.
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_google_recaptcha/issues)
