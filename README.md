...
- **Customizable Display Settings**:
  - For v3:
    ...
    - Set different score thresholds for specific pages, such as **Register**, **Guest Checkout**, **Reviews**, **Returns**, and **Contact**.
  - For v2 Checkbox:
